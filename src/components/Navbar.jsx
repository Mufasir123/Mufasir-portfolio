        ...
        text-xl items-center px-12 h-20'>
            ...
            >
                <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                    <li className='cursor-pointer'><Link to="skills" onClick={closeNav} smooth={true} offset={50} duration={500}>About</Link></li>
                    <li className='cursor-pointer'><Link to="portfolio" onClick={closeNav} smooth={true} offset={50} duration={500}>Projects</Link></li>
                    <li className='cursor-pointer'><Link to="contact" onClick={closeNav} smooth={true} offset={50} duration={500}>Contact</Link></li>
                </ul>
